...
//		System.out.println(rhs);
	...
	public static double[][] RMP(Instance instance,double[] x0,double U,double[] a,double[] h,double V,int P,int R, double beta,double limit) throws IloException {
		IloCplex ilcplex =new IloCplex();
		ilcplex.setOut(null);
	...
	public static Solution solveOA(Instance instance,double[] h,double[] a,int P,int R, double U, double V,double beta,double limit) throws IloException{
		...
		double time1 = System.nanoTime();
		int fnum=instance.getFnum();
		double[] x0=new double[fnum];
		double[][] LeaderSol1=RMP(instance,x0,U/2,a,h,V/2,1,1,beta,limit);
		//double[][] FollowerSol1=SOCP.SeparationSOCP(instance,LeaderSol1, a, h, V/2, 1, beta,limit);
		double[][] FollowerSol1=RMP(instance,LeaderSol1[0],U/2,a,h,V/2,1,1,beta,limit);
		double[][] LeaderSol2=RMP(instance,combine(LeaderSol1, FollowerSol1)[0],U/2,a,h,V/2,1,1,beta,limit);
		double[][] LeaderSol=combine(LeaderSol1, LeaderSol2);
		//double[][] FollowerSol2=SOCP.SeparationSOCP(instance,combine(combine(LeaderSol1, FollowerSol1),LeaderSol2), a, h, V/2, 1, beta,limit);
		//double[][] FollowerSol=combine(FollowerSol1, FollowerSol2);
		double[][] FollowerSol=SOCP.SeparationSOCP(instance,combine(LeaderSol1, LeaderSol2), a, h, V, R, beta,limit);
		double time2 = System.nanoTime();                                   
	...
	public static void main(String[] args) throws IOException, IloException, MWException{
		...
		double limit=0.4;
		double beta=2;
		Solution sol=UpAlg_Alter.solveOA(instance,h,a,P,R,U,V,beta,limit);
