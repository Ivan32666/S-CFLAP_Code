...
public class Main {
	...
	public static void batchSolve(int P,int R, int filenum, String namefilepath,double beta,double limit,double U, double V,double a0) throws IOException, IloException {
...
//				double V=a[0]*R/2;
				...
				//Solution sol=simultaneousCFLDP.simultaneousModel(instance, h, a, P, R, U, V, beta,limit);
//				PEH peh=new PEH();
//				Solution sol=peh.solvePEH(instance,h,a,P,R,U,V,beta,limit);
...
//				list2.add(sol.getTime());
				CreateFile(fnum,cnum,P,R,U,V,sol,beta,j,a0);
	...
	public static void CreateFile(int fnum,int cnum,int P,int R,double U,double V,Solution solution,double beta,int j,double a0) throws IOException {
		String fileName = "RandomResults/"+"EX_discrete/"+cnum+"-"+fnum+"-"+P+"-"+R+"-"+U+"-"+V+"-"+"continuous"+"-"+j+".txt";
		//String fileName = "RandomResults/"+"EX for Table 8/"+cnum+"-"+fnum+"-"+P+"-"+R+"-"+U+"-"+V+"-"+j+"-"+"Simultaneous"+".txt";
		//String fileName = "RandomResults/"+"EX9/"+cnum+"-"+fnum+"/"+cnum+"-"+fnum+"-"+P+"-"+R+"-"+U+"-"+V+"-"+j+"-"+"OA_Acc"+".txt";
		//String fileName = "RandomResults/"+"Qi_OR/"+cnum+"-"+fnum+"-"+P+"-"+R+"-"+U+"-"+V+"-"+j+".txt";
...
//			writer.write("子问题时间");
	...
	public static void main(String[] args) throws IOException, IloException { 
		...
		batchSolve(P,R,filenum,namefilepath1,beta,limit,U,V,a0);
...
//		P=4;R=4;
//		String namefilepath2="RandomData/data2.txt";
//		batchSolve(P,R,filenum,namefilepath2,beta,limit);
//		P=3;R=3;
